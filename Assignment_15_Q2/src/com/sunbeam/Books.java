...
public class Books implements Serializable {
	...
	public static void writeBooks(ArrayList<Books> list) {
		try (FileOutputStream fout = new FileOutputStream("GoodBooooks.txt")) {
	...
	public static void readBooks(ArrayList<Books> list) {
		try (FileInputStream fin = new FileInputStream("GoodBooooks.txt")) {
			try (ObjectInputStream din = new ObjectInputStream(fin)) {
				list = (ArrayList<Books>) din.readObject();
